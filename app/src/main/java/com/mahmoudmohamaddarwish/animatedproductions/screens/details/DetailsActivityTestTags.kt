...
const val DETAILS_TITLE_TEXT_TEST_TAG = "DETAILS_TITLE_TEXT_TEST_TAG"

const val DETAILS_OVERVIEW_TEXT_TEST_TAG = "DETAILS_OVERVIEW_TEXT_TEST_TAG"

const val DETAILS_LOADING_INDICATOR_TEST_TAG: String = "details loading indicator test tag"

const val DETAILS_ERROR_MESSAGE_TEST_TAG: String = "details error message test tag"